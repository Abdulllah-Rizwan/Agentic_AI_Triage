        ...
        <div className="space-y-4">
          <div className="rounded-xl border border-gray-800 bg-gray-900 p-5">
            ...
            <div className="mt-4 border-t border-gray-800 pt-3 text-xs text-gray-500">
              Received {format(parseAPIDate(caseDetail.received_at), "PPpp")}
            </div>
          </div>
          ...
          {caseDetail.soap_report ? (
            <>
              ...
              <p className="text-xs text-gray-600">
                Generated by {caseDetail.soap_report.model_used} · {format(parseAPIDate(caseDetail.soap_report.generated_at), "PPp")}
              </p>
            </>
          ) : (
